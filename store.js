...
function load(guildId) {
    ...
    try {
        ...
        // sanitizar por si faltan campos nuevos
...
// Reemplaza la sesión por completo (usado por el botón "Retroceder" para
// limpiar campos de pasos posteriores en vez de arrastrarlos).
